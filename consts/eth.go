...
var (
	...
	ChainIdMap  = map[string]int64***REMOVED***
		ChainTypeEth: 1,
		ChainTypeBsc: 56,
	***REMOVED***
	UniSwapWrapperTokenContractMap = map[string]common.Address***REMOVED***
		ChainTypeEth: common.HexToAddress(WETHAddress),
		ChainTypeBsc: common.HexToAddress(WBNBAddress),
	***REMOVED***

	UniSwapFactoryContractMap = map[string]common.Address***REMOVED***
		ChainTypeEth: common.HexToAddress(UniSwapV2FactoryAddress),
		ChainTypeBsc: common.HexToAddress(PancakeFactoryAddress),
	***REMOVED***

	UniSwapRouterContractMap = map[string]common.Address***REMOVED***
