...
func (_ERC20 *ERC20Caller) Generator(opts *bind.CallOpts) (string, error) {
	var out []interface{}
...
//
// Solidity: function generator() pure returns(string)
func (_ERC20 *ERC20Session) Generator() (string, error) {
...
//
// Solidity: function generator() pure returns(string)
func (_ERC20 *ERC20CallerSession) Generator() (string, error) {
	return _ERC20.Contract.Generator(&_ERC20.CallOpts)
}
